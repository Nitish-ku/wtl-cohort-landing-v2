  ...
  return (
    ...
    >
      <div className="container-modal rounded-panel bg-white border border-ink/10 shadow-modal p-8 text-center">
        ...
        <p className="text-ink/60 text-small mb-6">
          ₹499 one-time · generates your landing page copy, pricing model, and outreach scripts for you.
        </p>
        <button
          ref={upgradeBtnRef}
          onClick={onUpgrade}
          className="w-full rounded-pill bg-wtl-sage text-white font-semibold py-3 mb-3 hover:brightness-110 transition"
        >
          Pay ₹499 and get access →
        </button>
        <button onClick={onSkip} className="w-full rounded-pill border border-ink/15 text-ink/70 py-3 hover:border-ink/30 transition">
